    ...
    <div class="max-w-md w-full mx-auto">
        @if(session('email'))
            <div class="bg-red-100 text-red-800 pl-4 pr-10 py-4 rounded relative" role="alert">
                ...
                <span class="block sm:inline text-sm mx-4 max-sm:ml-0 max-sm:mt-1">{{ session('email') }}</span>
            </div>
        @endif
        ...
        <form class="space-y-4 md:space-y-6" method="post" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-between gap-2 mt-6">
                <div class="flex items-center">
                    <input id="remember-me" name="remember" type="checkbox" class="h-4 w-4 shrink-0 border-gray-300 rounded" />
                    <label for="remember-me" class="ml-3 block text-sm">
                        Remember me
                    </label>
                </div>
                <div>
                    <a href="/request" class="text-sm font-semibold hover:underline">
                        Forgot Password?
                    </a>
                </div>
            </div>
            <div class="mt-10">
                ...
                <p class="text-sm text-center mt-6">Don't have an account <a href="{{ route('Form-register') }}"
